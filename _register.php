        ...
        <div class="rg-wrapper">
            <div class="rg-box">
                <div class="rg-content">
                    ...
                    <form class="rg-form">
                        <label for="user" class="rg-form__lable-user">Username<span>*</span></label>
                        <input id="user" type="text" class="rg-form__input-user">
                        <label for="email" class="rg-form__lable-email">Email address<span>*</span></label>
                        <input id="email" type="text" class="rg-form__input-email">
                        <label for="password" class="rg-form__lable-password">Password<span>*</span></label>
                        <input id="password" type="text" class="rg-form__input-password">

                        <div class="rg-form-row">
                            <button class="rg-btn"><a href="#">Register</a></button>
                        </div>
                    </form>
                </div>
            </div>
